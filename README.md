...
- NumPy Sort nhanh hơn hàng nghìn lần so với các thuật toán Python tự cài đặt.
- C++ `std::sort` cũng vượt trội so với Python thuần.
- Sự khác biệt về hiệu năng thể hiện rõ khi xử lý dữ liệu kích thước lớn (1 triệu phần tử).

---

## 8. Nhận xét

- Các thư viện chuẩn (NumPy, C++) cho hiệu năng vượt trội trong thực tế.
- Các thuật toán có cùng độ phức tạp lý thuyết vẫn có hiệu năng thực thi khác nhau đáng kể.
- Khi kích thước dữ liệu tăng lớn, chênh lệch giữa cài đặt tối ưu và cài đặt thủ công trở nên rất rõ ràng.
...
5. Trong ứng dụng thực tế, nên ưu tiên sử dụng các thư viện tối ưu thay vì tự cài đặt.
